...
const deployments = {
    ...
    CaskSubscriptions: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "0x0D985780F56e47Fd271d1e4e7d39571A16Bd6f17",
        },
        [environments.PRODUCTION]: {
            ...
            [chains.OPTIMISM_MAINNET.chainId]: '0xD054F8866fc45c4387d56D2340dCA08d83E14A5e',
            [chains.BSC_MAINNET.chainId]: '0xD054F8866fc45c4387d56D2340dCA08d83E14A5e',
        },
    ...
    CaskSubscriptionPlans: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "0xA93D22f5AeDbEB8c8034Bb294dAA51Bc0Cb7e8f1",
        },
        [environments.PRODUCTION]: {
            ...
            [chains.OPTIMISM_MAINNET.chainId]: '0xD252A4C836C75063867f0193325b328CCe6B7306',
            [chains.BSC_MAINNET.chainId]: '0xD252A4C836C75063867f0193325b328CCe6B7306',
        },
        [environments.DEVELOPMENT]: {
    ...
    CaskSubscriptionManager: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "0x0644331350BDa992A3d97fE0469856A6e339790f",
        },
        [environments.PRODUCTION]: {
            ...
            [chains.OPTIMISM_MAINNET.chainId]: '0x331979A83644574E56035E4b43d3ca68Ce793918',
            [chains.BSC_MAINNET.chainId]: '0x331979A83644574E56035E4b43d3ca68Ce793918',
        },
        [environments.DEVELOPMENT]: {
    ...
    CaskVault: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "0xA4b47B472C0F2E6a35E502c32e225Ffc8eE1317E",
        },
        [environments.PRODUCTION]: {
            ...
            [chains.OPTIMISM_MAINNET.chainId]: '0x3b2b4b547dAEEbf3A703288CB43650f0F287b9ff',
            [chains.BSC_MAINNET.chainId]: '0x3b2b4b547dAEEbf3A703288CB43650f0F287b9ff',
        },
        [environments.DEVELOPMENT]: {
    ...
    CaskDCA: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "0xDdcE74C684282CDBEa9723EF715Ee43e24b3A434",
        },
        [environments.PRODUCTION]: {
            ...
            [chains.OPTIMISM_MAINNET.chainId]: '0x96d59127cCD1c0e3749E733Ee04F0DfbD2f808c8',
            [chains.BSC_MAINNET.chainId]: '0x96d59127cCD1c0e3749E733Ee04F0DfbD2f808c8',
        },
        [environments.DEVELOPMENT]: {
    ...
    CaskDCAManager: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "0xbC7d7C77963B4b513743Bf1e66b88D41C9D3d3bd",
        },
        [environments.PRODUCTION]: {
            ...
            [chains.OPTIMISM_MAINNET.chainId]: '0x83aA6a992Ff3ef3766679Cc90E8C60a04afcC171',
            [chains.BSC_MAINNET.chainId]: '0x83aA6a992Ff3ef3766679Cc90E8C60a04afcC171',
        },
        [environments.DEVELOPMENT]: {
    ...
    CaskP2P: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "0xCf5EA5cBe519F7a6eEaD217c32df9E3b5E526841",
        },
        [environments.PRODUCTION]: {
            ...
            [chains.OPTIMISM_MAINNET.chainId]: '0xccB54bF4171bc8C11e78ca40f3a3bd3B721EF361',
            [chains.BSC_MAINNET.chainId]: '0x775Df9836945B0E95eD5F6A3269Bf22F6b426e85',
        },
        [environments.DEVELOPMENT]: {
    ...
    CaskP2PManager: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "0x2e74FfD025102579845F3f2D2dA60fD1DdF4b84C",
        },
        [environments.PRODUCTION]: {
            ...
            [chains.OPTIMISM_MAINNET.chainId]: '0xb8A52a086262E1d6c7494bDCb824f884f41FC5f8',
            [chains.BSC_MAINNET.chainId]: '0x1A4620123cfD10c73D9Cdd65879c1Fb6312ef654',
        },
        [environments.DEVELOPMENT]: {
    ...
    CaskChainlinkTopup: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "0x0000000000000000000000000000000000000000",
        },
        [environments.PRODUCTION]: {
            [chains.POLYGON_MAINNET.chainId]: '0xD621F2C0374d32771d7Cfbec348a63F26f9d7c4F',
            [chains.AVAX_MAINNET.chainId]: '0xC787791a0d0122b9cCCD2cA9d9FEBcAC3831f0fc',
            ...
            [chains.ARBITRUM_MAINNET.chainId]: '0xe465A32D2826dc5A42FDc75624a18Ee35A25a131',
            [chains.OPTIMISM_MAINNET.chainId]: '0x6deE81A058c48013686520Ac2f5E445dde645062',
            [chains.BSC_MAINNET.chainId]: '0x28418B0AB2C00142a865971dcC6a4b1154DaD19E',
        },
        [environments.DEVELOPMENT]: {
    ...
    CaskChainlinkTopupManager: {
        ...
        [environments.PRODUCTION]: {
            [chains.POLYGON_MAINNET.chainId]: '0x8839A1941A9cB2deCfC05C3191c598Bf2aC5Be0C',
            [chains.AVAX_MAINNET.chainId]: '0xD621F2C0374d32771d7Cfbec348a63F26f9d7c4F',
            [chains.FANTOM_MAINNET.chainId]: '0x0000000000000000000000000000000000000000',
            [chains.AURORA_MAINNET.chainId]: '0x0000000000000000000000000000000000000000',
            [chains.MOONBEAM_MAINNET.chainId]: '0x0000000000000000000000000000000000000000',
            [chains.GNOSIS_MAINNET.chainId]: '0x0000000000000000000000000000000000000000',
            [chains.CELO_MAINNET.chainId]: '0x0000000000000000000000000000000000000000',
            [chains.ARBITRUM_MAINNET.chainId]: '0x7D872c19C5A3839313c76F47CD595Ac843068aCC',
            [chains.OPTIMISM_MAINNET.chainId]: '0xFdbF3Be079AfbD27aE89378839B48Ad7BD18Bbe4',
            [chains.BSC_MAINNET.chainId]: '0x781a5958954a10066feB7B3E94D22D9F8c163e8b',
        },
        [environments.DEVELOPMENT]: {
    ...
    SubgraphUrl: {
        [environments.TESTNET]: {
            ...
            [chains.BASE_TESTNET.chainId]: "https://api.studio.thegraph.com/query/25834/cask-protocol-goerlibase/v1.1.0",
        },
        [environments.PRODUCTION]: {
            ...
            [chains.OPTIMISM_MAINNET.chainId]: 'https://api.thegraph.com/subgraphs/name/caskprotocol/cask-protocol-optimism',
            [chains.BSC_MAINNET.chainId]: 'https://api.thegraph.com/subgraphs/name/caskprotocol/cask-protocol-bsc',
        },
        [environments.DEVELOPMENT]: {
